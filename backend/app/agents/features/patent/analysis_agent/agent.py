...
from app.agents.features.patent.clients.patent_functional_tools import (
    PatentDiscoveryTool,
    PatentDetailTool,
    PatentLegalTool
)
from app.agents.features.patent.clients.patent_analysis_tool import PatentAnalysisTool
