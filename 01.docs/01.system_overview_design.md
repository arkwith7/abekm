...
> **상세 문서**: `01.docs/12.agent_design_for_patent_analysis.md` (Section 8, 9), `01.docs/14.patent_collection_to_myknowledge_flow.md`
...
- `01.docs/14.patent_collection_to_myknowledge_flow.md`: 특허 수집 → MyKnowledge 통합 플로우
...
├── 12.agent_design_for_patent_analysis.md      # L2: 특허 분석 에이전트 상세 설계
├── 14.patent_collection_to_myknowledge_flow.md # L2: 특허 수집 → 지식 컨테이너 플로우
...
| L2 | `12.agent_design_for_patent_analysis.md` | 특허 분석 에이전트 상세 설계, 도구/파이프라인 | 개발자, QA |
| L2 | `14.patent_collection_to_myknowledge_flow.md` | 수집→처리→통합 데이터 플로우 | 개발자, 운영 |
...
- [ ] `12.agent_design_for_patent_analysis.md` - 도구/파이프라인 상세
- [ ] `14.patent_collection_to_myknowledge_flow.md` - 데이터 플로우 변경
